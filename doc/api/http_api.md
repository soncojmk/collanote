...
The API is designed in a way, so you can reuse your existing user system with their permissions, and map it to Collanote. Means: Your web application still has to do authentication, but you can tell Collanote via the api, which visitors should get which permissions. This allows Collanote to fit into any web application and extend it with real-time functionality. You can embed the pads via an iframe into your website.
...
Authentication works via a token that is sent with each request as a post parameter.  There is a single token per Collanote deployment.  This token will be random string, generated by Collanote at the first start. It will be saved in APIKEY.txt in the root folder of Collanote. Only Collanote and the requesting application knows this key. Token management will not be exposed through this API.
...
this functions helps you to map your application group ids to Collanote group ids
...
this functions helps you to map your application author ids to Collanote author ids
